...
$S=\left\{s_j=T_i^j=\{t_i^{j}\}_0^{\Lambda_j-1}\right\}_0^{H-1}$ be a sequence
...
\begin{itemize}
    ...
    section) and the first event $s_0$ of original structure $S$, and
    ...
    \item Pitch translation, or transposition, is a displacement $\tau$ of the material to a
        ...
        where $\Xi_0$ is a reference value, such as the pitch of a section $S$ or of the first event $s_0$.
    ...
    in $S$; at the end, as a suffix; or in the middle, dividing $S$ and making
    ...
    \item Accompaniment. Both orchestration and melodic lines present when $S$ occurs can suffer modifications and be considered as a variation of $S$ itself.
\end{itemize}
