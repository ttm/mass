...
The Git repository~\cite{massRepo} holds all the PDF documents and Python scripts.
...
musical structures~\cite{MASSA,figgusOriginal,figgusEspacializacao,3Trios}.
...
\end{itemize}
\noindent In fact, this framework was used in a number of contexts, including courses, software implementations and for making music~\cite{vimeoLM,vivace,repoDissertacao,dissertacao}.
