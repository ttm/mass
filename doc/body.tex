...
\noindent where, if $\Lambda_{ITD} < 0$, it is necessary to change $t_i$ by $t_i'$
...
is related to all the points in a circle parallel to
...
on the filtering of frequencies by the head, pinna and torso.
...
With these values, there are perceived wave pulses which propagate for $652.08m$ ($83.79k$ samples in $f_s=44.1kHz$) before reaching the ear.
In addition, sound reflections made after propagation for
$34.32m$ ($4.41k$ samples in $f_s=44.1kHz$) have incidences less distinct by hearing.
These first reflections are particularly important to spatial sensation.
The first incidence is the direct sound, described by ITD and IID of Equations~\ref{eq:dti} and~\ref{eq:dii}.
...
the separation between the first reflections is $8-90ms$ ($350-4000$ samples in $f_s=44.1kHz$).
